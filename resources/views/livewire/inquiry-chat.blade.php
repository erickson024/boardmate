        ...
        <div class="col-12 col-lg-10">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-muted mb-2">
                                <small>{{ substr($inquiry->property->address, 0, 40) }} | ₱{{ number_format($inquiry->property->propertyCost, 0) }} monthly</small>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4" wire:key="sidebar">
                    ...
                    @endphp
                    <x-host-contact-card :user="$otherUser" :property="$inquiry->property" :showActions="$userRole === 'tenant'" />
                    ...
                    <div class="mt-3">
                        <div class="row gx-2">
                            <div class="col-6">
                                <button
                                    class="btn btn-sm btn-success fw-medium py-2 w-100"
                            ...
                            <div class="col-6">
                                <button
                                    class="btn btn-sm btn-danger fw-medium py-2 w-100"
                            ...
                            <div class="col-12 mt-2">
                                <button
                                    class="btn btn-sm btn-outline-dark fw-medium py-2 w-100"
