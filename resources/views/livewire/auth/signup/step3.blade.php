    ...
    <div class="d-flex flex-column align-items-center my-4">
        ...
        <div class="position-relative profile-upload-wrapper">
            ...
            <label for="profilePhotoInput"
                ...
                @if ($profile_photo instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile)
                {{-- Live preview for new upload --}}
                <img src="{{ $profile_photo->temporaryUrl() }}" class="w-100 h-100 object-fit-cover" alt="Profile Preview">
                @elseif ($profile_photo)
                {{-- Display stored photo if it exists in session --}}
                <img src="{{ asset('storage/' . $profile_photo) }}" class="w-100 h-100 object-fit-cover" alt="Profile Preview">
                @else
                {{-- Default placeholder --}}
